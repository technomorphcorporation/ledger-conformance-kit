...
public final class Reports {
    ...
    public static String html(List<Result> rs, String ledgerName) {
        ...
        return """
            ...
            <footer>A failing invariant is not a code-review opinion. It is a reproducible run
              ...
              is a property left unmeasured \u2014 either the adapter does not declare a capability
              the check needs, or the ledger's own model cannot express the transaction the check
              submits. Each such row carries which, and neither is a pass.</p></footer>
            </div></body></html>
    ...
    public static String json(List<Result> rs, String ledgerName) {
        StringBuilder sb = new StringBuilder("{\"ledger\":\"").append(jesc(ledgerName))
                ...
                .append("\"notApplicable\":\"unmeasured: either an undeclared capability, or a ")
                .append("transaction this ledger's model cannot express. Never a pass\"}")
                .append(",\"results\":[");
